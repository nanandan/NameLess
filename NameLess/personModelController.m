...
{   
    ...
    personDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"personDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(personDataViewController *)viewController];
